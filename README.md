...
2026-09-13 的實機黑畫面已確認是舊 portable 執行目錄缺少 66 個必要檔案。以完整原版 v1.1.0 還原並改為固定資料夾啟動後，全螢幕、計時、Spotify 與 Esc 已恢復，使用者亦確認正常。這是原版修復，桌面配色尚未更新；詳見 [診斷與修復紀錄](docs/BLACK-SCREEN-RECOVERY.md)。
